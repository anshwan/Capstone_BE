...
// ✅ 1. 모델 파일 업로드
const handleModelUpload = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    try {
        ...
        for (const file of files) {
            ...
            const { s3_key, url } = yield (0, s3Service_1.uploadToS3)(file.path, s3Key);
...
// ✅ 2. 트랜잭션 생성
const handleTransactionInit = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const wallet = (_a = req.user) === null || _a === void 0 ? void 0 : _a.wallet;
    ...
    try {
        const txBase64 = yield (0, solanaService_1.createInitializeTx)(wallet, s3_key, royalty, is_derivative);
...
const handleModelComplete = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const wallet = (_a = req.user) === null || _a === void 0 ? void 0 : _a.wallet;
...
const getAllModellist = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const buyLicense = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const wallet = (_a = req.user) === null || _a === void 0 ? void 0 : _a.wallet;
...
const getOwnedModels = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const wallet = (_a = req.user) === null || _a === void 0 ? void 0 : _a.wallet;
    if (!wallet) {
